...
def insert_into_database(username, score):
    try:
        connection = mysql.connector.connect(
            host='localhost',
            database='stack_game_db',
            user='root',
            password=''
        )
        ...
        if connection.is_connected():
            ...
            connection.commit()
            print("Record inserted successfully into scores table. Username:", username, "Score:", score)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN:
                    ...
                    username = text
                    # Call insert_into_database here with the username and score
                    insert_into_database(username, score)
